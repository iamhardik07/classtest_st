//Create a c++ program that uses 2 vectors 1 for name and 1 for grade
#include <bits/stdc++.h>
using namespace std;
...
int main()
{
    ...
    int size;
    cout<<"Enter number of names and grades to be entered"<<endl;
    cin>>size;
    
    string name;
    int grade;
    
    cout<<"Enter names and grade"<<endl;
